...
if(isset($_POST["submit"])) {
    ...
    */ 
    ...
    if (isset($_SESSION["signup"])) {
        ...
        $insertUserQuery = "INSERT INTO users (firstname, lastname, username, email, password, avatar, is_admin) VALUES ('$firstname', '$lastname', '$username', '$email', '$hashedPassword', '$avatarName', 0)";
